...
.lcms-gallery__coverflow-slide img.lcms-gallery__img { width: 100%; height: auto; display: block; border-radius: 12px; }
.lcms-gallery__coverflow-slide--active { transform: translateY(-50%) scale(1); opacity: 1; z-index: 10; }
